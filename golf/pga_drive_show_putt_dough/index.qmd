...
The "No Tech" version of this activity (where the correlation matrix is provided) should take less than 15 minutes to complete in class. Time might go up to half an hour if students are using technology to compute correlations and draw graphs.
:::
...
Bigness, A. &amp; Lock, R (2026 February 25) PGA Drive for Show, Putt for Dough. "The SCORE Network." [https://doi.org/10.17605/OSF.IO/VHDBE](https://doi.org/10.17605/OSF.IO/VHDBE)
